...
var mech1Popup = '<img id="image" src="ulo.jpg" alt="porost"> <p>Szkoła</p>';
var mech2Popup = '<img id="image" src="stadion.jpg" alt="porost"> <p>Stadion</p>';

// szkola
var mech1 = L.marker([54.37063005711632, 18.60900704588365],
	{ alt: 'porost1' }).addTo(map)
	.bindPopup(mech1Popup).openPopup();

// stadion
var mech2 = L.marker([54.38989574306403, 18.640272323625727],
	{ alt: 'porost2' }).addTo(map)
